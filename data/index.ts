...
export const gridItems = [
  ...
  export const workExperience = [
    ...
    },
    {
      ...
      desc: "Created a web application for a real estate rental system using ASP.NET Core MVC. Integrated machine learning features such as recommendation, sentiment analysis, and price prediction, improving rental system functionality and user experience.",
      className: "md:col-span-2",
      thumbnail: "./exp4.svg",
    },
    {
      ...
      desc: "Participated in the development of a static website using Javascript, Bootstrap, HTML and Css. Worked in a dynamic and collaborative environment to ensure high quality results and improved usability of the website.",
      className: "md:col-span-2",
      thumbnail: "./exp2.svg",
    },
    {
